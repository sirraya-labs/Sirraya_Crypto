...
pub const ETA: i32 = 4; // Table 1 ML-DSA-65 (bound for secrets)
pub const TAU: usize = 49; // Table 1 ML-DSA-65 (weight of challenge)
pub const BETA: i32 = 196; // Table 1: τ·η = 49 * 4
pub const GAMMA1: i32 = 1 << 19; // Table 1 ML-DSA-65 (2^19 = 524288)
pub const GAMMA2: i32 = (Q - 1) / 32; // Table 1 ML-DSA-65 = 261888
...
pub const SECRETKEYBYTES: usize = 4032; // Table 2: ρ(32)+K(32)+tr(64)+s1(640)+s2(768)+t0(2496)
...
// Packing sizes - ML-DSA-65 specific
...
pub const POLYETA_PACKEDBYTES: usize = 128; // Alg 24: 256×4/8 (η=4 → 4 bits)
...
/// Size of s1 vector in bytes: L × POLYETA_PACKEDBYTES = 5 × 128 = 640
pub const S1_BYTES: usize = L * POLYETA_PACKEDBYTES;

/// Size of s2 vector in bytes: K × POLYETA_PACKEDBYTES = 6 × 128 = 768
